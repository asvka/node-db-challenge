...
Well, this is kind of a trick question right? SQL is the language that we use to communicate with the relational database system.
...
An intermediary table that holds the foreign keys that reference the primary key on the related tables.
